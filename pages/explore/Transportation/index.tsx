...
import { TransportationPage } from "../../../components/companies/TransportationPage/TransportationPage";
...
const Transportation: React.FC<Redux> = (props) => {
  ...
  function checkReturn() {
    ...
    } else return <TransportationPage />;
  }
