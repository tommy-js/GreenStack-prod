...
import { CommunicationPage } from "../../../components/companies/CommunicationPage/CommunicationPage";
...
const Communication: React.FC<Redux> = (props) => {
