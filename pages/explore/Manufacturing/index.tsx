...
import { ManufacturingPage } from "../../../components/companies/industries/ManufacturingPage/ManufacturingPage";
...
const Manufacturing: React.FC<Redux> = (props) => {
  ...
  function checkReturn() {
    ...
    } else return <ManufacturingPage />;
  }

  return checkReturn();
};

export default connect(mapStateToProps)(Manufacturing);
