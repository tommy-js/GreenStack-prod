...
import { FollowingPage } from "../../../components/Homepage/FollowingPage/FollowingPage";
...
const FollowingPages: React.FC<Redux> = (props) => {
...
export default connect(mapStateToProps)(FollowingPages);
